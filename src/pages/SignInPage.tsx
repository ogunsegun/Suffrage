    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-indigo-400 via-indigo-600 to-indigo-900 p-4">
        ...
        <Card className="w-full max-w-md">
          <h1 className="text-3xl font-bold text-white text-center mb-4">Two-Factor Authentication</h1>
          <p className="text-white/70 text-center mb-8">Enter the code from your authenticator app</p>
